...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.setHandler(handlers); // Установка обработчиков на сервере
    ...
    // Метод для создания и регистрации MBean
    private static void createMBean(AccountServer accountServer) throws MalformedObjectNameException, InstanceAlreadyExistsException, MBeanRegistrationException, NotCompliantMBeanException {
        ...
        MBeanServer mbs = ManagementFactory.getPlatformMBeanServer(); // Получение платформенного MBean сервера
        ObjectName name = new ObjectName("Admin:type=AccountServerController"); //имя для MBean
